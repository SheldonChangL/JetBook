...
- 測試語料：20 篇模擬真實內部文件（雷射/光學製程 SOP、規格書、IT 與行政規範），涵蓋公司名「捷揚光電」、料號（JB-1024/JB-2048）、中英混排（pgvector、ESD、force push）、專業術語（FWHM、準直鏡）。
- 驗收查詢 14 條，關鍵案例：**以「捷揚」查得含「捷揚光電」的文件**（子字串魯棒性，內建 parser 與詞庫式斷詞的典型破口）。
